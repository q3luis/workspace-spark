package org.lpeinado.prueba.scala;
...
// mvn exec:exec -Dexec.executable="java" -Dexec.args="-cp %classpath org.lpeinado.prueba.scala.RunJobLocal 2 file:///some/path file:///some/other/path"
object RunJobLocal {
...
// mvn exec:exec -Dexec.executable="java" -Dexec.args="-cp %classpath org.lpeinado.prueba.scala.RunJobRemote 2 file:///some/path file:///some/other/path"
object RunJobRemote {
  def main(args: Array[String]) {
    val job = new Job
    if (args.size < 3) {
